  ...
  return (
    <div className={styles.projectContainer}>
      <div className='custom-shape-divider-bottom-1629420053'>
        <svg className={styles.waves2} data-name='Layer 1' viewBox='0 0 1200 120' preserveAspectRatio='none'>
          <path
      ...
      <div className={styles.projects} id='projects'>
        ...
        <div className='project project1'>
          <Image src={require('../../public/images/VGAPI.PNG')} alt='scotland' className={styles.projectImg} />
          <div className='projectContent'>
            ...
            <div className={styles.siteBtnContainer}>
              <button>
        ...
        <div className='project project3'>
          <Image src={require('../../public/images/Homepage2.png')} alt='Personal' className='projectImg' />
          <div className='projectContent'>
            <h4>Personal Site</h4>
        ...
        <div className='project project2'>
          <Image src={require('../../public/images/moviedb.png')} alt='' className='projectImg' />
          <div className='projectContent'>
            <h4>The Movie Database</h4>
            <div>
              A fully functional movie-info website which allows you to search for your favourite movies as well as showing you what is popular around the
              world.
            </div>
            <div className='siteBtnContainer'>
              <button>
        ...
        {/* Project 4 */}
        <div className='project project2'>
          <Image src={require('../../public/images/KoreanCounters.PNG')} alt='' className='projectImg' />
          <div className='projectContent'>
