        ...
        <div className={styles.hero}>
          <div className={styles.headline}>
            ...
            <div className={styles.hero_buttons}>
              <button className={styles.button_red}>
          ...
          <Image width={300} height={300} src={require('../../public/images/scotland.jpg')} alt='scotland church' />
        </div>
      </section>
      <div className='custom-shape-divider-bottom-1629420053'>
        <svg className='waves' data-name='Layer 1' viewBox='0 0 1200 120' preserveAspectRatio='none'>
          <path
